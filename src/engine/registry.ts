...
import { periodicalModule } from './rules/periodicals.js';
import { bookModule } from './rules/books.js';
 ...
 */
const MODULES: RuleModule[] = [caseModule, shortformModule, statuteModule, periodicalModule, bookModule];
